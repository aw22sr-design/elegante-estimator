...
export const PRICING = {
  ...
  installation: 14.75,       // per square yard (Wall-to-Wall Installation)
  doubleStick: 6.50,         // per square yard (Double Stick Installation)
  ripUp: 5.00,               // per square yard (Rip Up & Disposal of Old Carpet)
  pad40oz: 9.50,             // per square yard
